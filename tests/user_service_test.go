...
func TestUserServiceListExistedRecordOrganizationName(t *testing.T) {
	testcases := []SearchTestCase{
		// search existed record.
		{"Search by existed _id and check organization name", SearchArgs{"_id", "55"}, "Strezzö", false},
		{"Search by existed url and check organization name", SearchArgs{"url", "http://initech.tokoin.io.com/api/v2/users/55.json"}, "Strezzö", false},
		{"Search by existed external_id and check organization name", SearchArgs{"external_id", "95387bef-5870-4453-9431-be6f9864bad8"}, "Strezzö", false},
		{"Search by existed name and check organization name", SearchArgs{"name", "Benjamin Stephenson"}, "Bitrex", false},
		{"Search by existed alias and check organization name", SearchArgs{"alias", "Miss Louisa"}, "Bitrex", false},
		{"Search by existed created_at and check organization name", SearchArgs{"created_at", "2016-02-17T10:35:02 -11:00"}, "Strezzö", false},
		{"Search by existed shared and check organization name", SearchArgs{"shared", "true"}, "Bitrex", false},
		{"Search by existed timezone and check organization name", SearchArgs{"timezone", "Oman"}, "Bitrex", false},
		{"Search by existed last_login_at and check organization name", SearchArgs{"last_login_at", "2016-02-19T03:04:47 -11:00"}, "Bitrex", false},
		{"Search by existed email and check organization name", SearchArgs{"email", "hammondgaines@flotonic.com"}, "Bitrex", false},
		{"Search by existed phone and check organization name", SearchArgs{"phone", "8804-843-526"}, "Bitrex", false},
		{"Search by existed tags and check organization name", SearchArgs{"tags", "Frank"}, "Bitrex", false},
		{"Search by existed suspended and check organization name", SearchArgs{"suspended", "true"}, "Bitrex", false},
	}
